var w3m_official = 'http://web3dmol.duapp.com/';
...
w3m.tool = {
    ...
    pipelineGeometry : function () {
        w3m.ui.helper.showSlogan('Drawing ...');
        this.clearMain();  this.clearHet();  this.clearExt();
        this.plugin();
        this.fillMain();   this.fillHet();   this.fillExt();
        this.bufferMain(); this.bufferHet(); this.bufferExt();
        this.recycle();
    },
    pipelineMain : function () {
        w3m.ui.helper.showSlogan('Drawing ...');
        this.clearMain();   this.clearExt();
        this.plugin();
        this.fillMain();    this.fillExt();
        this.bufferMain();  this.bufferExt();
        this.recycle();
    },
    pipelineHet : function () {
        w3m.ui.helper.showSlogan('Drawing ...');
        this.clearHet();   this.clearExt();
        this.plugin();
        this.fillHet();    this.fillExt();
        this.bufferHet();  this.bufferExt();
        this.recycle();
    },
    pipelineLabel : function () {
        w3m.ui.helper.showSlogan('Drawing ...');
        this.clearExt();    this.clearLabel();  
        this.plugin();
        this.fillExt();     this.fillLabel();
        this.bufferExt();   this.bufferLabel();
        this.draw();
    },
    ...
    plugin : function () {
        ...
        for ( var i in w3m.mol ) {
            var mol = w3m.mol[i],
                ...
                hide_enable = false;
            for ( var i in hide ) {
                if ( hide[i].length > 0 ) { hide_enable = true; break; }
            }
        ...
        for ( var i in w3m.mol ) {
            ...
            for ( var i in highlight ) {
                if ( highlight[i].length > 0 ) { highlight_enable = true; break; }
            }
    ...
    fillMain : function () {
        ...
        w3m.fillqueue_main.forEach(function (q) {
            switch ( q[1] ) {
                case w3m.DOT          : that.fillMainAsDot           ( q[2], q[3], q[4], q[5] ); break;
                case w3m.LINE         : that.fillMainAsLine          ( q[2], q[3], q[4], q[5] ); break;
                case w3m.BACKBONE     : that.fillMainAsBackbone      ( q[2], q[3], q[4], q[5] ); break;
                case w3m.TUBE         : that.fillMainAsTube          ( q[2], q[3], q[4], q[5] ); break;
                case w3m.CARTOON      : that.fillMainAsCartoon       ( q[2], q[3], q[4], q[5] ); break;
                case w3m.PUTTY        : that.fillMainAsPutty         ( q[2], q[3], q[4], q[5] ); break;
                case w3m.CUBE         : that.fillMainAsCube          ( q[2], q[3], q[4], q[5] ); break;
                case w3m.STRIP        : that.fillMainAsStrip         ( q[2], q[3], q[4], q[5] ); break;
                case w3m.RIBBON       : that.fillMainAsRibbon        ( q[2], q[3], q[4], q[5] ); break;
                case w3m.RAILWAY      : that.fillMainAsRailway       ( q[2], q[3], q[4], q[5] ); break;
                case w3m.ARROW        : that.fillMainAsArrow         ( q[2], q[3], q[4], q[5] ); break;
                case w3m.STICK        : that.fillMainAsStick         ( q[2], q[3], q[4], q[5] ); break;
                case w3m.SPHERE       : that.fillMainAsSphere        ( q[2], q[3], q[4], q[5] ); break;
                case w3m.BALL_AND_ROD : that.fillResidueAsBallAndRod ( q[2], q[3], q[4] );        break;
                default               : void(0);
            }
        });
        // vertex -> drawqueue
    ...
    fillHet : function () {
        ...
        w3m.fillqueue_het.forEach(function (q) {
            switch ( q[1] ) {
                case w3m.DOT          : that.fillHetAsDot        ( q[2] ); break;
                case w3m.LINE         : that.fillHetAsLine       ( q[2] ); break;
                case w3m.STICK        : that.fillHetAsStick      ( q[2] ); break;
                case w3m.BALL_AND_ROD : that.fillHetAsBallAndRod ( q[2] ); break;
                case w3m.SPHERE       : that.fillHetAsSphere     ( q[2] ); break;
                default               : void(0);
            }
        });
        // vertex -> drawqueue
    ...
    fillLabel : function () {
        ...
        w3m.fillqueue_label.forEach(function (q) {
            if ( q[0] == w3m.ATOM_MAIN ) {
                switch ( q[1] ) {
                    case w3m.LABEL_AREA_ATOM           : that.labelMainAtom          ( q[3], q[4], q[5], q[6], q[2] ); break;
                    case w3m.LABEL_AREA_BACKBONE       : that.labelMainBackbone      ( q[3], q[4], q[5], q[6], q[2] ); break;
                    case w3m.LABEL_AREA_RESIDUE        : that.labelMainResidue       ( q[3], q[4], q[5], q[6], q[2] ); break;
                    case w3m.LABEL_AREA_RESIDUE_CENTER : that.labelMainResidueCenter ( q[3], q[4], q[5], q[6], q[2] ); break;
                    case w3m.LABEL_AREA_CHAIN          : that.labelMainChain         ( q[3], q[4], q[5], q[6], q[2] ); break;
                    case w3m.LABEL_AREA_MOL            : that.labelMainMol           ( q[3] ); break;
                    default                            : void(0);
                }
            } else {
                switch ( q[1] ) {
                    case w3m.LABEL_AREA_ATOM : that.labelHetAtom ( q[3], q[4], q[2] ); break;
                    case w3m.LABEL_AREA_MOL  : that.labelHetMol  ( q[3] ); break;
                    default                  : void(0);
                }
            }
        });
    ...
    bufferMain : function () {
        ...
        w3m.vertex_main_point = []; w3m.vertex_main_line = []; w3m.vertex_main_triangle = [];
        w3m.vertex_main_line_strip = []; w3m.vertex_main_triangle_strip =[];
    },
    bufferHet : function () {
        w3m.shader.switch('geometry');
    ...
    highlightSegment : function ( mol_id, chain_id, start, stop, operation ) {
        ...
        for ( var residue_id = start; residue_id <= stop; residue_id++ ) {
            ...
            switch ( operation || w3m.TOGGLE ) {
                case w3m.ADD    : w3m_array_add   (highlight, residue_id); break;
                case w3m.REMOVE : w3m_array_remove(highlight, residue_id); break;
                case w3m.TOGGLE : w3m_array_toggle(highlight, residue_id); break;
            }
    ...
    hideSegment : function ( mol_id, chain_id, start, stop, operation ) {
        ...
        for ( var residue_id = start; residue_id <= stop; residue_id++ ) {
            ...
            switch ( operation || w3m.TOGGLE ) {
                case w3m.ADD    : w3m_array_add   (hide, residue_id); break;
                case w3m.REMOVE : w3m_array_remove(hide, residue_id); break;
                case w3m.TOGGLE : w3m_array_toggle(hide, residue_id); break;
            }
        ...
        switch ( w3m.config.color_mode_het ) {
            ...
            case w3m.COLOR_BY_REP :
                switch ( w3m.config.rep_mode_het ) {
                    case w3m.HIDE         : var color = w3m.color.rep.hide;         break;
                    case w3m.DOT          : var color = w3m.color.rep.dot;          break;
                    case w3m.LINE         : var color = w3m.color.rep.line;         break;
                    case w3m.STICK        : var color = w3m.color.rep.stick;        break;
                    case w3m.BALL_AND_ROD : var color = w3m.color.rep.ball_and_rod; break;
                    case w3m.SPHERE       : var color = w3m.color.rep.sphere;       break;
                }
                mol.color.het = mol.atom.het.map(function (atom) {
                    return color;
                });
    ...
    crossFiller : function ( atom, msg ) {
        ...
        pt2vrtx( [ id, [x+r, y, z], color ] );  pt2vrtx( [ id, [x-r, y, z], color ] );
        pt2vrtx( [ id, [x, y+r, z], color ] );  pt2vrtx( [ id, [x, y-r, z], color ] );
        pt2vrtx( [ id, [x, y, z+r], color ] );  pt2vrtx( [ id, [x, y, z-r], color ] );
    },
    lineFiller : function ( atom_1, atom_2, msg ) {
        if ( !atom_1 || !atom_2 ) { return false; }
        var msg = msg || {},
            het = w3m_isset(msg.het) ? msg.het : false,
            ext = w3m_isset(msg.ext) ? msg.ext : false;
        var pt2vrtx = ( !het && !ext ) ? w3m.tool.point2vertexMainLine : ( het ? w3m.tool.point2vertexHetLine : w3m.tool.point2vertexExtLine );
    ...
    railwayFiller : function ( frame, msg ) {
        ...
        this.railwayShell( frame, shell, 
            { end_mode : end_mode, side_differ : side_differ, side_color : side_color, inner_differ : inner_differ, inner_face : inner_face } );
        // fill
        var len = frame.length,
    ...
    arrowFiller : function ( frame, msg ) {
        ...
        this.cubeFiller( frame.slice(0, len-(seg+1)), 
            { end_mode : w3m.END_XO, side_differ : side_differ, side_color : side_color, inner_differ : inner_differ, inner_face : inner_face } );
        // arrowhead
            ...
            for ( var ii = part_start; ii <= part_stop; ii++ ) {
                ...
                for ( var iii = 0, lll = inner_link.length; iii < lll; iii++ ) {
                    ...
                    var atom_info_1 = mol.getMain(residue[atom_name_1]),
                        atom_info_2 = mol.getMain(residue[atom_name_2]),
                        ref_tnb     = w3m_isset(link_map[ii]) ? link_map[ii][atom_name_1] : null;
                    this.stickFiller(atom_info_1, atom_info_2, { end_mode : w3m.END_OO, radius : radius, ref_tnb : ref_tnb });
                }
            }
        }
    },
    ...
    fillMainAsCubeStripRibbonRailwayArrow : function ( rep, mol_id, chain_id, start, stop ) {
        ...
        for ( var i = 0, l = part.length; i < l; i++ ) {
            ...
            /* Fill */
            switch ( rep ) {
                case w3m.CUBE    : this.cubeFiller(frame);    break;
                case w3m.STRIP   : this.stripFiller(frame);   break;
                case w3m.RIBBON  : this.ribbonFiller(frame);  break;
                case w3m.RAILWAY : this.railwayFiller(frame); break;
                case w3m.ARROW   : this.arrowFiller(frame);   break;
            }
        }
    },
    ...
    fillMainAsCartoon : function ( mol_id, chain_id, start, stop ) {
        ...
        for ( var i = 0, l = part.length; i < l; i++ ) {
            ...
            for ( var ii = part_start; ii <= part_stop; ii++ ) {
                switch ( ss_map[ii][0] ) {
                    case w3m.HELIX : case w3m.HELIX_HEAD : case w3m.HELIX_BODY : case w3m.HELIX_FOOT : 
                        ss_array[ii] = w3m.HELIX; break;
                    case w3m.SHEET : case w3m.SHEET_HEAD : case w3m.SHEET_BODY : case w3m.SHEET_FOOT : 
                        ss_array[ii] = w3m.SHEET; break;
                    case w3m.LOOP  : case w3m.LOOP_HEAD  : case w3m.LOOP_BODY  : case w3m.LOOP_FOOT  : 
                        ss_array[ii] = w3m.LOOP;  break;
                }
            }
            ...
            for ( var ii in ss_split ) {
                ...
                switch ( ss_type ) {
                    case w3m.HELIX : 
                        ss.helix.push([ ss_start, ss_stop ]); break;
                    case w3m.SHEET : 
                        ss.sheet.push([ ss_start, ss_stop ]); break;
                    case w3m.LOOP  : 
                        ss.loop.push([ ss_start == part_start ? ss_start : ss_start - 1, 
                                       ss_stop  == part_stop  ? ss_stop  : ss_stop  + 1 ]); break;
                }
            }
            // Fill
            ...
            for ( var ii in ss.helix ) {
                ...
                if ( w3m.config.geom_helix_mode == w3m.HIDE ) {
                    ...
                    geom_frame.forEach(function(item) { item[6] ? inner_face_turnover_count++ : void(0) });
                    ...
                    var inner_differ = w3m.config.geom_helix_inner_differ ? true : false,
                        ...
                        msg = { inner_differ : inner_differ, inner_face : inner_face, 
                                side_differ  : side_differ,  side_color : side_color };
                    switch ( w3m.config.geom_helix_mode ) {
                        case w3m.CUBE :    this.cubeFiller   ( geom_frame, msg ); break;
                        case w3m.STRIP :   this.stripFiller  ( geom_frame, msg ); break;
                        case w3m.RAILWAY : this.railwayFiller( geom_frame, msg ); break;
                        case w3m.RIBBON :  this.ribbonFiller ( geom_frame, msg ); break;
                        case w3m.ARROW :   this.arrowFiller  ( geom_frame, msg ); break;
                        default :          this.cubeFiller   ( geom_frame, msg );
                    }
                }
            }
            for ( var ii in ss.sheet ) {
                ...
                if ( w3m.config.geom_sheet_mode == w3m.HIDE ) {
                    ...
                    switch ( w3m.config.geom_sheet_mode ) {
                        ...
                        case w3m.RIBBON :  this.ribbonFiller (geom_frame, msg); break;
                        case w3m.ARROW :   this.arrowFiller  (geom_frame, msg); break;
                        default :          this.arrowFiller  (geom_frame, msg);
                    }
                }
            }
        ...
        for ( var i = 0, l = part.length; i < l; i++ ) {
            ...
            for ( var ii = part_start; ii <= part_stop; ii++ ) {
                ...
                if ( normal_token_1 && normal_token_2 ) {
                    ...
                    // fill
                    this.stickFiller( normal_info_1, normal_info_2, { radius : w3m.config.geom_tube_radius, end_mode : end_mode } );
                }
                offset++;
            }
        }
    ...
    fillSSBond : function ( mol_id ) {
        ...
        for ( var i in ssbond_map ) {
            ...
            switch ( rep_map[chain_id_1][residue_id_1] ) {
                ...
                case w3m.LINE     : 
                case w3m.STICK    : 
                case w3m.SPHERE   : p1sg = residue_1.sg; break;
                case w3m.BACKBONE : 
                case w3m.TUBE     : 
                case w3m.CARTOON  :
                case w3m.PUTTY    :
                ...
                case w3m.RIBBON   :
                case w3m.RAILWAY  :
                case w3m.ARROW    : p1ca = residue_1.ca; p1cb = residue_1.cb; p1sg = residue_1.sg; break;
            }
            switch ( rep_map[chain_id_2][residue_id_2] ) {
                case w3m.DOT      : 
                case w3m.LINE     : 
                case w3m.STICK    : 
                case w3m.SPHERE   : p2sg = residue_2.sg; break;
                case w3m.BACKBONE :
                case w3m.TUBE     :
                case w3m.CARTOON  :
                case w3m.PUTTY    :
                ...
                case w3m.RIBBON   :
                case w3m.RAILWAY  :
                case w3m.ARROW    : p2ca = residue_2.ca; p2cb = residue_2.cb; p2sg = residue_2.sg; break;
            }
    ...
    fillCellUnit : function () {
        ...
        if ( mol.info.cell.len && mol.info.cell.angle ) {
            ...
            this.lineFiller ( atom_1, atom_2, { ext : true } ); this.lineFiller ( atom_1, atom_3, { ext : true } );
            this.lineFiller ( atom_2, atom_4, { ext : true } ); this.lineFiller ( atom_3, atom_4, { ext : true } );
            this.lineFiller ( atom_1, atom_5, { ext : true } ); this.lineFiller ( atom_2, atom_6, { ext : true } );
            this.lineFiller ( atom_3, atom_7, { ext : true } ); this.lineFiller ( atom_4, atom_8, { ext : true } );
            this.lineFiller ( atom_5, atom_6, { ext : true } ); this.lineFiller ( atom_5, atom_7, { ext : true } );
            this.lineFiller ( atom_6, atom_8, { ext : true } ); this.lineFiller ( atom_7, atom_8, { ext : true } );
        }
    },
        ...
        for ( var i in mol.tree.het ) {
            ...
            chain.forEach(function(atom_id) {
                if ( mol.atom.het[atom_id][3] == 'hoh' ) {
                    ...
                    that.sphereFiller( mol.getHet(atom_id), { radius : w3m.geometry.radius[mol.atom.het[atom_id][9]], het : true } );
                }
            });
        }
    },
    ...
    labeler : function ( atom_info, label_content ) {
        ...
        switch ( label_content ) {
            // Atom
            case w3m.LABEL_ATOM_NAME : this.point2vertexLabel([atom_xyz, atom_name]); break;
            case w3m.LABEL_ATOM_ID : this.point2vertexLabel([atom_xyz, atom_id]); break;
            case w3m.LABEL_ATOM_NAME_AND_ID : this.point2vertexLabel([atom_xyz, atom_name + '-' + atom_id]); break;
            // Element
            case w3m.LABEL_ELEMENT : this.point2vertexLabel([atom_xyz, element]); break;
            case w3m.LABEL_ELEMENT_AND_ID : this.point2vertexLabel([atom_xyz, element + '-' + atom_id]); break;
            // Residue
            case w3m.LABEL_RESIDUE_NAME : this.point2vertexLabel([atom_xyz, residue_name]); break;
            case w3m.LABEL_RESIDUE_ID : this.point2vertexLabel([atom_xyz, residue_id]); break;
            case w3m.LABEL_RESIDUE_NAME_AND_ID : this.point2vertexLabel([atom_xyz, residue_name + residue_id]); break;
            // Chain
            case w3m.LABEL_CHAIN_ID : this.point2vertexLabel([atom_xyz, chain_id]); break;
            case w3m.LABEL_CHAIN_AND_RESIDUE : this.point2vertexLabel([atom_xyz, chain_id + '.' + residue_name + residue_id]); break;
            case w3m.LABEL_CHAIN_AND_RESIDUE_ID : this.point2vertexLabel([atom_xyz, chain_id + '.' + residue_id]); break;
            // Mix
            case w3m.LABEL_MIX : this.point2vertexLabel([atom_xyz, chain_id + '.' + residue_name + residue_id + '-' + atom_name]); break;
            // Other
            case w3m.LABEL_B_FACTOR : this.point2vertexLabel([atom_xyz, atom_info[8]]); break;
            case w3m.LABEL_OCCUPANCY : this.point2vertexLabel([atom_xyz, atom_info[7]]); break;
            case w3m.LABEL_VDW_RADIUS : this.point2vertexLabel([atom_xyz, w3m.geometry.radius[atom_info[9]].toFixed(2)]); break;
        }
    },
...
w3m.buffer = {
    ...
    init : function () {
        this.buffer_index = gl.createBuffer(); this.buffer_index_vertex = gl.createBuffer();
        this.buffer_main  = gl.createBuffer(); this.buffer_het = gl.createBuffer(); this.buffer_ext = gl.createBuffer();
        this.buffer_label = gl.createBuffer();
    }
}
...
w3m.camera = {
    ...
    up  : [ 0, 1,  0 ],
    fovy   : Math.PI / 6,
    aspect : function () { return canvas.width / canvas.height },
    near   : 0.1,
    far    : 100,
        ...
        canvas.addEventListener('mousemove', function(event) {
            if ( w3m.mouse.pressed ) {
                ...
                if ( w3m_isset(e.buttons) ) { // FireFox
                    switch ( e.buttons ) {
                        case 1 : w3m.mouse.rotateHandle(e.clientX, e.clientY); break; // 1 not 0
                        case 2 : w3m.mouse.panHandle(e.clientX, e.clientY); break;
                        default : return false;
                    }
                } else {
                    switch ( e.button ) {
                        case 0 : w3m.mouse.rotateHandle(e.clientX, e.clientY); break;
                        case 2 : w3m.mouse.panHandle(e.clientX, e.clientY); break;
                        default : return false;
                    }
                }
...
w3m.pdb = function ( source ) {
    ...
    var doJrnl = function ( s ) {
        switch( w3m_sub(s, 13, 16).toLowerCase() ) {
            case 'ref'  : o.info.journal = w3m_capword(w3m_sub(s, 20, 47));
                          o.info.volume  = w3m_sub(s, 52, 55);
                          o.info.page    = w3m_sub(s, 57, 61); break;
            case 'pmid' : o.info.pmid    = w3m_sub(s, 20, 79); break;
            case 'doi'  : o.info.doi     = w3m_sub(s, 20, 79); break;
        }
    }
    var doRemark = function ( s ) {
        var remark_id = w3m_sub(s, 8, 10);
        switch ( remark_id ) {
            case '2' : o.info.resolution = w3m_sub(s, 24, 30); break;
        }
    }
    ...
    var doConnect = function ( s ) {
        ...
        other(12, 16); other(17, 21); other(22, 26); other(27, 31);
        ...
        for ( var i in o.chain ) {
            ...
            ss_fragment.forEach(function(fg){
                var fg_start = fg[0],
                    ...
                    fg_range = [ fg[0], fg[1] ];
                switch ( fg[2] ) {
                    case w3m.HELIX : var head = w3m.HELIX_HEAD, body = w3m.HELIX_BODY, foot = w3m.HELIX_FOOT; break;
                    case w3m.SHEET : var head = w3m.SHEET_HEAD, body = w3m.SHEET_BODY, foot = w3m.SHEET_FOOT; break;
                    case w3m.LOOP  : var head = w3m.LOOP_HEAD,  body = w3m.LOOP_BODY,  foot = w3m.LOOP_FOOT;  break;
                }
    ...
    switch ( typeof source ) {
        ...
        case 'object' : loadFromFile(source); break;
        default : return false;
    }
    return o;
}
...
w3m.ui = {
    ...
    sidebox : function ( node, field ) {
        ...
        for ( var i in box.body ) {
            ...
            for ( var ii in item ) {
                var it = item[ii];
                switch ( it[0] ) {
                    case w3m.UI_BANNER             : s += w3m.ui.html.banner             (it[1]); break;
                    case w3m.UI_BANNER_START       : s += w3m.ui.html.banner_start       (it[1]); break;
                    case w3m.UI_BANNER_STOP        : s += w3m.ui.html.banner_stop        (); break;
                    case w3m.UI_RADIO              : s += w3m.ui.html.radio              (it[1], it[2], it[3], it[4]); break;
                    case w3m.UI_CHECKBOX           : s += w3m.ui.html.checkbox           (it[1], it[2], it[3]); break;
                    case w3m.UI_BUTTON_BLUE        : s += w3m.ui.html.button_blue        (it[1], it[2]); break;
                    case w3m.UI_BUTTON_GREEN       : s += w3m.ui.html.button_green       (it[1], it[2]); break;
                    case w3m.UI_BUTTON_RED         : s += w3m.ui.html.button_red         (it[1], it[2]); break;
                    case w3m.UI_FLOAT              : s += w3m.ui.html.float              (it[1], it[2], it[3], it[4]); break;
                    case w3m.UI_INT                : s += w3m.ui.html.int                (it[1], it[2], it[3], it[4]); break;
                    case w3m.UI_COLOR              : s += w3m.ui.html.color              (it[1], it[2], it[3]); break;
                    case w3m.UI_COLOR_INDEX        : s += w3m.ui.html.color_index        (it[1], it[2], it[3]); break;
                    case w3m.UI_VECTOR             : s += w3m.ui.html.vector             (it[1], it[2], it[3]); break;
                    case w3m.UI_SELECT             : s += w3m.ui.html.select             (it[1], it[2], it[3], it[4]); break;
                    case w3m.UI_REP_MODE_MAIN      : s += w3m.ui.html.rep_mode_main      (it[1], it[2], it[3], it[4]); break;
                    case w3m.UI_REP_MODE_HET       : s += w3m.ui.html.rep_mode_het       (it[1], it[2], it[3], it[4]); break;
                    case w3m.UI_COLOR_MODE_MAIN    : s += w3m.ui.html.color_mode_main    (it[1], it[2], it[3], it[4]); break;
                    case w3m.UI_COLOR_MODE_HET     : s += w3m.ui.html.color_mode_het     (it[1], it[2], it[3], it[4]); break;
                    case w3m.UI_LABEL_AREA_MAIN    : s += w3m.ui.html.label_area_main    (it[1], it[2], it[3], it[4]); break;
                    case w3m.UI_LABEL_AREA_HET     : s += w3m.ui.html.label_area_het     (it[1], it[2], it[3], it[4]); break;
                    case w3m.UI_LABEL_CONTENT_MAIN : s += w3m.ui.html.label_content_main (it[1], it[2], it[3], it[4]); break;
                    case w3m.UI_LABEL_CONTENT_HET  : s += w3m.ui.html.label_content_het  (it[1], it[2], it[3], it[4]); break;
                }
            }
            s += '</div>';
        }
        ...
        sidebox : function () {
            ...
            w3m_$('w3m-seqplot-main-area').addEventListener('mouseup', function (event) {
                if ( w3m.ui.seqplot.holddown ) {
                    ...
                    switch( e.button ) {
                        case 0 : cls = 'w3m-seqplot-highlight'; cls_alter = 'w3m-seqplot-hide'; break;
                        case 2 : cls = 'w3m-seqplot-hide'; cls_alter = 'w3m-seqplot-highlight'; break;
                        default : return false;
                    }
                    if ( target.classList.contains('w3m-seqplot-residue') ) {
                        var td = target.parentNode;
                    ...
                    switch( e.button ) {
                        case 0 : w3m.api.highlightToggle(token[0], token[1], parseInt(token[2]), parseInt(token[3])); break;
                        case 2 : w3m.api.hideToggle(token[0], token[1], parseInt(token[2]), parseInt(token[3])); break;
                    }
                }
            });
        },
    ...
    measure : {
        ...
        add : function ( type ) {
            switch ( type ) {
                case w3m.MEASURE_DISTANCE       : var point = { a : null, b : null }; break;
                case w3m.MEASURE_VECTOR_ANGLE   : var point = { a : null, b : null, c : null }; break;
                case w3m.MEASURE_DIHEDRAL_ANGLE : var point = { a : null, b : null, c : null, d: null }; break;
                case w3m.MEASURE_TRIANGLE_AREA  : var point = { a : null, b : null, c : null }; break;
                default : return;
            }
            // g.measure
        ...
        sidebox : function () {
            ...
            for ( var i in ms_list ) {
                switch ( ms_list[i].type ) {
                    case w3m.MEASURE_DISTANCE       : ms_list_by_type.distance.push(i); break;
                    case w3m.MEASURE_VECTOR_ANGLE   : ms_list_by_type.vector_angle.push(i); break;
                    case w3m.MEASURE_DIHEDRAL_ANGLE : ms_list_by_type.dihedral_angle.push(i); break;
                    case w3m.MEASURE_TRIANGLE_AREA  : ms_list_by_type.triangle_area.push(i); break;
                }
            }
            // HTML
            s += '<div class="w3m-form-vsp"></div>';
    ...
    colorpicker : {
        ...
        r2t : function ( channel ) {
            ...
            switch ( channel ) {
                case 'r' :
                case 'g' :
                case 'b' : v = Math.round(math.clamp(o.value, [ 0, 255 ])); break;
                case 'a' : v = parseFloat(Number(math.clamp(o.value, [ 0.0, 1.0 ])).toFixed(2)); break;
            }
            o.value = v;
            d.value = v;
            this.tr2rect();
    ...
    vectormaker : {
        ...
        ok : function () {
            ...
            var vector_text = this.vector.map(function(n) { return n.toFixed(1) })
        ...
        init : function ( atom_id ) {
            ...
            if ( atom_type == w3m.ATOM_MAIN ) {
                ...
                if ( mol.chain[chain_id] == w3m.CHAIN_AA ) {
                    ...
                    switch ( ss[0] ) {
                        case w3m.HELIX : case w3m.HELIX_HEAD : case w3m.HELIX_BODY : case w3m.HELIX_FOOT : var ss_name = 'Helix'; break;
                        case w3m.SHEET : case w3m.SHEET_HEAD : case w3m.SHEET_BODY : case w3m.SHEET_FOOT : var ss_name = 'Sheet'; break;
                        case w3m.LOOP  : case w3m.LOOP_HEAD  : case w3m.LOOP_BODY  : case w3m.LOOP_FOOT  : var ss_name = 'Coil';  break;
                    }
                }
...
w3m.api = {
    ...
    refreshColorByMode : function ( key ) {
        ...
        if ( color_id ) {
            ...
            for ( var i in w3m.mol ) {
                var mol = w3m.mol[i];
                if ( mol.color.main.some(function(n) { return n == color_id }) ) {
                    should_refresh_main = true;
                    break;
                }
            }
            ...
            for ( var i in w3m.mol ) {
                var mol = w3m.mol[i];
                if ( mol.color.het.some(function(n) { return n == color_id }) ) {
    ...
    representation : function ( structure, mode ) {
        switch ( structure ) {
            case w3m.ATOM_MAIN : w3m.api.switchRepModeMain(mode); break;
            case w3m.ATOM_HET  : w3m.api.switchRepModeHet (mode); break;
        }
    },
    color : function ( structure, mode ) {
        switch ( structure ) {
            case w3m.ATOM_MAIN : w3m.api.switchColorModeMain(mode); break;
            case w3m.ATOM_HET  : w3m.api.switchColorModeHet (mode); break;
        }
    },
    label_area : function ( structure, area ) {
        switch ( structure ) {
            case w3m.ATOM_MAIN : w3m.api.switchLabelAreaMain(area); break;
            case w3m.ATOM_HET  : w3m.api.switchLabelAreaHet (area); break;
        }
    },
    label_content : function ( structure, content ) {
        switch ( structure ) {
            case w3m.ATOM_MAIN : w3m.api.switchLabelContentMain(content); break;
            case w3m.ATOM_HET  : w3m.api.switchLabelContentHet (content); break;
        }
    },
